            ...
            <div class="row bialy">
                <div class="col-11">
                    ...
                    <ul class="nav nav-tabs">
                        <li class="nav-item"><a class="nav-link <?php echo $all ?>" aria-current="page"
                                href="baselinker_warehouse.php">Pokaż Wszystkie</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $all ?>" aria-current="page"
                                href="baselinker_warehouse.php?number=0">Wyświetl tylko poniżej 0</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $stal ?>" aria-current="page"
                                href="baselinker_warehouse.php?paint=Stal">Stal</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $czarny ?>" aria-current="page"
                                href="baselinker_warehouse.php?paint=Czarny">Czarny</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $bialy ?>" aria-current="page"
                                href="baselinker_warehouse.php?paint=Biały">Biały</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $szary ?>" aria-current="page"
                                href="baselinker_warehouse.php?paint=Szary">Szary</a></li>
                        <li class="nav-item"><a class="nav-link <?php echo $zloty ?>" aria-current="page"
                                href="baselinker_warehouse.php?paint=Złoty">Złoty</a></li>
                    </ul>
                    <div class="filtr p-2"
                        style="border-top: 1px solid black; border-bottom: 1px solid black; margin: 0;">
                        <button class="Button Button--outline" onclick="printDiv()">Wydrukuj</button>
                        <a href="functions/synchronization.php"><button class="Button Button--outline">Synchronizacja z
                                magazynem</button></a>
